...
This plugin just add a simple shortcode to the functions.php file, which embed the latest version of the Font Awesome css (5.0.7). Now using a javascript and the Font Awesome CDN to delivery faster and ligther icons. Now including automatic updates to the icons without even update the plugin!
...
IF you are upgrading from v3, don't worry, your old shortcodes will continue working ;)
